...
echo "   Built: $OUT"
echo ""
echo "   To install it — use the card route, NOT 'Upload plugin':"
echo "     1. Start a Cowork thread and ask the cowork-plugin-management"
echo "        plugin's create-cowork-plugin skill to build the plugin,"
echo "        pasting in the hooks.json from $(basename "$OUT")."
echo "     2. Click 'Save plugin' on the card it returns."
echo "     3. Start a NEW Cowork thread to test."
echo ""
echo "   Do NOT use the desktop app's 'Upload plugin'. It reports success but"
echo "   never delivers the plugin to a Cowork session — it cost three days in"
echo "   August. See docs/CURRENT-STATE.md."
echo ""
